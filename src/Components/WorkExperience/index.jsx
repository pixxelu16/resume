            ...
            <div className="brand-work">
                <div className="row">
                    <div className="col-md-6">
                        <div className="color-white padding-bottom-90 ">
                        ...
                        <div className="color-white padding-bottom-180">
                        ...
                        <div className="color-white">
                            <p className='font-24 weight-700'>Title Design</p>
                        </div>
                    ...
                    <div className="col-md-6">
                        <div className='color-white font-24 weight-300 work-custom'>
                            <ul style={{ listStyle: 'disc', paddingLeft: '1.5rem' }}>
                                ...
                                <li>Rebuilt Altcore’s brand with a fresh visual identity and strategic direction</li>
                            </ul>
                            ...
                            <ul style={{ listStyle: 'disc', paddingLeft: '1.5rem' }}>
                                ...
                                <li>Updated packaging graphics and labels for better brand alignment.</li>
                            </ul>
                            <div style={{ margin: '6rem 0' }}></div>
                            ...
                            <ul style={{ listStyle: 'disc', paddingLeft: '1.5rem' }}>
                                ...
                                <li>Illustration System for Bal Raksha Bharat with Social Media as well as Publication application.</li>
                            </ul>
                            ...
                            <ul style={{ listStyle: 'disc', paddingLeft: '1.5rem' }}>
                                ...
                                <li>Designed and developed an inclusive illustration system for Prabhat Foundation.</li>
                                <li>Built branding for Magic Mystery, an online and offline accessory store.</li>
                            </ul>
                            <div style={{ margin: '6rem 0' }}></div>

                            <ul style={{ listStyle: 'disc', paddingLeft: '1.5rem' }}>
                                <li><strong>Athithi Daivo Bhava</strong> – Animated short by Pranav Holla</li>
                                <li><strong>Of Men & Puppets</strong> – Graphic novel by Rohit Issac Thomas</li>
                                <li><strong>Babi</strong> – Short films by Maithili Ajay Phatak</li>
                                <li><strong>Amala</strong> – Short films by Maithili Ajay Phatak</li>
                                <li><strong>Staged</strong> – Short film by Saundary Toppo</li>
                                <li><strong>Darar</strong> – Animated short by Gaurav Pati</li>
                                <li><strong>Rama</strong> – Graphic Novel by Dipankar Talukdar</li>
                            </ul>
                        </div>
...
export default BrandWorkHighlights;
